...
export class LoginComponent implements OnInit, OnDestroy {
    ...
    private async getLocalWalletFiles() {
        try {
            ...
            const db = new DatabaseStorageService('divergenticore');
    ...
    unlock() {
        ...
        this.globalService.setCoinName('Divergenti');
        ...
        this.apiService.getGeneralInfoOnce(walletInfo)
            .subscribe(
                response => {
                    ...
                    if (responseMessage.network === 'DivergentiMain') {
                        this.globalService.setCoinName('Divergenti');
                        this.globalService.setCoinUnit('DIVER');
