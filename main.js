...
var coin = { identity: 'diver', tooltip: 'Divergenti Core' }; // To simplify third party forks and different UIs for different coins, we'll define this constant that loads different assets.
...
electron_1.ipcMain.on('start-daemon', function (event, arg) {
    ...
    if (arg.mode === 'manual') {
        ...
        var msg = 'Divergenti Core was started in development mode. This requires the user to be running the daemon manually.';
        writeLog(msg);
